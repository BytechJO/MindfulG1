        ...
        <div className="paper animate__animated animate__backInDown" id="p3">
          ...
          <div className="content">
            <div className="Q1">
              ...
              <ul>
                <li>Noura<input type="radio" name="q1" value="0" onChange={handleChange} /></li>
                <li>Ben<input type="radio" name="q1" value="1" onChange={handleChange} /></li>
                <li>A neighbour<input type="radio" name="q1" value="2" onChange={handleChange} /></li>
              </ul>
            </div>
            ...
            <div className="Q2">
              ...
              <ul>
                <li>Throw trash on the ground<input type="radio" name="q2" value="0" onChange={handleChange} /></li>
                <li>Never use bins<input type="radio" name="q2" value="1" onChange={handleChange} /></li>
                <li>Take care of public places<input type="radio" name="q2" value="2" onChange={handleChange} /></li>
              </ul>
            </div>
            ...
            <div className="Q3" >
              ...
              <ul>
                <li>He ate more chips.<input type="radio" name="q3" value="0" onChange={handleChange} /></li>
                <li>He played games.<input type="radio" name="q3" value="1" onChange={handleChange} /></li>
                <li>He threw his rubbish in the bin.<input type="radio" name="q3" value="2" onChange={handleChange} /></li>
              </ul>
            </div>
