...
export const QuizPage = () => {
        ...
        <div className="paper animate__animated animate__backInDown" id="p3">
          ...
          <div className="content">
            <div className="Q1">
              ...
              <ul>
                <li>Helen was being nice to her. <input type="radio" name="q1" value="0" onChange={handleChange} /></li>
                <li>Helen wouldn’t let her have a turn. <input type="radio" name="q1" value="1" onChange={handleChange}/></li>
                <li>Helen gave her ice cream. <input type="radio" name="q1" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
 ...
 لتنسيق أفضل عبر CSS */}
            <div className="Q2">
              ...
              <ul>
                <li>Jump <input type="radio" name="q2" value="0" onChange={handleChange}/></li>
                <li>Shout <input type="radio" name="q2" value="1" onChange={handleChange}/></li>
                <li>Count to ten <input type="radio" name="q2" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
            ...
            <div className="Q3" >
              ...
              <ul>
                <li>Kim and Helen said sorry to each other. <input type="radio" name="q3" value="0" onChange={handleChange}/></li>
                <li>Kim and Helen had a fight. <input type="radio" name="q3" value="1" onChange={handleChange}/></li>
                <li>Kim and Helen played football. <input type="radio" name="q3" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
